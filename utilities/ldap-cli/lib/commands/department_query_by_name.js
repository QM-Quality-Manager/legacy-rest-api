...
async function departmentQueryByName(tenant, name, options) {
  ...
  const result = await ldapService.departmentQueryByName(authTokenKey, tenant, name);
...
module.exports = departmentQueryByName;