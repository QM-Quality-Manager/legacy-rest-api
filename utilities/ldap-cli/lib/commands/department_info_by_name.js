...
async function departmentInfoByName(tenant, name, options) {
  ...
  const result = await ldapService.departmentInfoByName(authTokenKey, tenant, name);
...
module.exports = departmentInfoByName;