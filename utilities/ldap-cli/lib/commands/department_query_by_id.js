...
async function departmentQueryById(tenant, id, options) {
  ...
  const result = await ldapService.departmentQueryById(authTokenKey, tenant, id);
...
module.exports = departmentQueryById;