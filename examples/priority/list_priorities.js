const { PriorityService } = require('../../lib/services');
const fs = require('fs');
...
(async () => {
  // Create user service
  let service = new PriorityService(endPoint);
  // Execute the service
  let result = await service.priorities(authTokenKey, tenant, userId, languageId, languageId);
